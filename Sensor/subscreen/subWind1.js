...
export default class SubWind1 extends Component {
  ...
  getone = () =>{
    ...
    .then((responseJson)=> {
      this.setState({
       dataSource2: responseJson.rowa,
      })
      this.setState({
        winds:this.state.dataSource2.map(element => element.ws),
      ...
      <SafeAreaView style={{flex:1,}}>
        ...
        <Animated.View style={{justifyContent:'center', alignItems:'center',flex:1,flexDirection:'row'}}>
                <Animated.View style={{flex:1, justifyContent:'center', alignItems:'center',}}>
                            ...
                            {
                                (fill)=>(
                                    <Text style={{fontSize:25, color:this.state.winds>99?'red':this.state.winds>95?'black':'blue'}}>
                                        {this.state.winds} m/s
                                    </Text>
