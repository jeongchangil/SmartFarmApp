...
export default class SubCo21 extends Component {
  ...
  getone = () =>{
    ...
    .then((responseJson)=> {
      ...
      this.setState({
        co2:this.state.dataSource2.map(element => element.co2),
        ...
        <Animated.View style={{justifyContent:'center', alignItems:'center',flex:1,flexDirection:'row'}}>
                <Animated.View style={{flex:1, justifyContent:'center', alignItems:'center',}}>
                            ...
                            >
                            {
                                ()=>(
                                    <View>
                                    <Text style={{fontSize:25, color:this.state.co2>100 ? 'red': this.state.co2>95 ? 'black':'blue'}}>
                                        {this.state.co2}
                                    </Text>
                                    <Text style={{ fontSize: 18, textAlign: 'center' }}> PPM </Text>
                                    </View>
