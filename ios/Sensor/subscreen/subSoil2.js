...
export default class SubSoil2 extends Component {
  ...
  getData = () =>{
   ...
   .then((responseData) => {
    ...
    this.setState({dataSource:responseData.rows})
    //이미지 url을 dataSource에 받아옴
    console.log(this.state.dataSource)
    this.setState({soilData : this.state.dataSource.map(dataSource => dataSource.soilhum)})
